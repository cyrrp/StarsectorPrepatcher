...
причины/остаточного риска в отчёте соответствующего выпуска из [`releases/`](releases/0.18.0.md).
...
- exact detached-Cargo/LOOT call-site guards, final vanilla `Economy.tripleStep/getEconomy` contract, exact-vanilla skip, spp10 explicit dispatch, subclass/rejection/error fallback, idempotence and changed-body fail-closed fixtures;
...
- actual-fork XStream 1.4.10 migration of a fixed spp9 XML fixture and spp10 round-trip proving that
